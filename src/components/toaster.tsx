...
// Toast Component
export const ToastComponent = React.memo(function ToastComponent({
  toast,
  onDismiss,
}: { toast: Toast; onDismiss: () => void }): JSX.Element | null {
...
export function Toaster({
  toasts,
  onDismiss,
}: { toasts: Toast[]; onDismiss: (id: string) => void }): JSX.Element | null {
